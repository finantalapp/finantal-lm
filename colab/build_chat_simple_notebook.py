...
CELLS = [
    ...
    code("# 4) load model + tokenizer, then launch the chat UI\n"
         ...
         "\n"
         "@torch.no_grad()\n"
         "def generate(prompt, max_new_tokens=200, temperature=0.8, top_p=0.9, repetition_penalty=1.3):\n"
         "    ids = SP.encode(prompt, out_type=int)\n"
         "    if SP.bos_id() >= 0: ids = [SP.bos_id()] + ids\n"
         ...
         "    additional_inputs=[\n"
         "        gr.Slider(16, 512, value=200, step=8, label='max_new_tokens'),\n"
